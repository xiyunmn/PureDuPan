...
object FeatureKeys {
    ...
    const val KEY_POPUP_BLOCK = "popup_block"
    const val KEY_BLOCK_POPUP_OPERATION_ANIMATION = "block_operation_animation"
    const val KEY_BLOCK_POPUP_OPERATION_AFX = "block_operation_afx"
    const val KEY_BLOCK_POPUP_NEW_USER_OFFER = "block_new_user_offer"
    const val KEY_BLOCK_POPUP_NEW_USER_REWARD = "block_new_user_reward"
    const val KEY_BLOCK_POPUP_NEW_USER_REWARD_V2 = "block_new_user_reward_v2"
    const val KEY_BLOCK_POPUP_COIN_PROMOTION = "block_coin_promotion"
    const val KEY_BLOCK_POPUP_COUPON_GIFT_V3 = "block_coupon_gift_v3"
    const val KEY_BLOCK_POPUP_COUPON_GIFT_V2 = "block_coupon_gift_v2"
    const val KEY_BLOCK_POPUP_LIFE_COUPON = "block_life_coupon"
    const val KEY_BLOCK_POPUP_LIFE_PRODUCT = "block_life_product"
    const val KEY_BLOCK_POPUP_LIFE_PRODUCT_V3 = "block_life_product_v3"
    const val KEY_BLOCK_POPUP_LIFE_V10 = "block_life_v10"
    const val KEY_BLOCK_POPUP_LIFE_V10_REPURCHASE = "block_life_v10_repurchase"
    const val KEY_BLOCK_POPUP_LIFE_COMBO = "block_life_combo"
    const val KEY_BLOCK_POPUP_LIFE_LIMITED = "block_life_limited"
    const val KEY_BLOCK_POPUP_LIFE_RETENTION = "block_life_retention"
    const val KEY_BLOCK_POPUP_LIFE_PRICE_UPGRADE = "block_life_price_upgrade"
    const val KEY_BLOCK_POPUP_OVERDUE_UNION = "block_overdue_union"
    const val KEY_BLOCK_POPUP_OVERDUE_COUPON = "block_overdue_coupon"
    const val KEY_BLOCK_POPUP_OVERDUE_PRODUCT = "block_overdue_product"
    const val KEY_BLOCK_POPUP_MY_PAGE_OFFER = "block_my_page_offer"
    const val KEY_BLOCK_POPUP_INCENTIVE_ENTRANCE = "block_incentive_entrance"
    const val KEY_BLOCK_POPUP_INCENTIVE_GUIDE = "block_incentive_guide"
    const val KEY_BLOCK_POPUP_INCENTIVE_NEXT = "block_incentive_next"
    const val KEY_BLOCK_POPUP_FREE_MODE = "block_free_mode_dialog"
    const val KEY_BLOCK_POPUP_FREE_MODE_NEW = "block_free_mode_new_dialog"
    const val KEY_BLOCK_POPUP_FREE_MODE_FLOAT = "block_free_mode_float"
    const val KEY_BLOCK_POPUP_MIGHTY_MARKETING = "block_mighty_marketing"
    const val KEY_BLOCK_POPUP_MODERATE_MARKETING = "block_moderate_marketing"
    const val KEY_BLOCK_POPUP_SEARCH_MEMBERSHIP = "block_search_membership"
    const val KEY_BLOCK_POPUP_TRANSFER_COUPON = "block_transfer_coupon"
    const val KEY_BLOCK_POPUP_TRANSFER_LIMIT = "block_transfer_limit_marketing"
    const val KEY_BLOCK_POPUP_TRANSFER_SPACE = "block_transfer_space_marketing"
    ...
    const val KEY_HIDE_HOME_RECOMMEND_SECTION = "hide_home_recommend_section"
    ...
    const val KEY_HOME_RECENT_ITEM_LIMIT_ENABLED = "home_recent_item_limit_enabled"
    const val KEY_HOME_RECENT_ITEM_LIMIT = "home_recent_item_limit"
    const val KEY_HOME_SAVE_VERTICAL_LAYOUT = "home_save_vertical_layout"
    const val KEY_HOME_SAVE_ITEM_LIMIT = "home_save_item_limit"
