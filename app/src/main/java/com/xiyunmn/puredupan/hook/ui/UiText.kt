...
object UiText {
    object Settings {
        ...
        const val POPUP_BLOCK_ENABLE_ALL_LABEL = "一键启用"
        const val POPUP_BLOCK_ENABLE_ALL_DESC = "启用下方全部弹窗屏蔽选项"
        ...
        const val BLOCK_IN_APP_DIALOG_LABEL = "运营活动海报"
        const val BLOCK_IN_APP_DIALOG_DESC = "屏蔽主界面的活动海报及收起动画"
        ...
        const val HOME_RECENT_ITEM_LIMIT_LABEL = "最近栏显示数量"
        const val HOME_RECENT_ITEM_LIMIT_DESC = "启用后按下方设置控制「最近」栏数量及首页滚动范围"
        const val HOME_RECENT_ITEM_LIMIT_VALUE_LABEL = "显示条数"
        const val HOME_RECENT_ITEM_LIMIT_VALUE_DESC = "设置首页「最近」栏最多显示的内容条数"
        const val HOME_SAVE_VERTICAL_LAYOUT_LABEL = "转存/订阅纵向排列"
        const val HOME_SAVE_VERTICAL_LAYOUT_DESC = "将首页「转存/订阅」内容改为随页面滚动的纵向列表"
        const val HOME_SAVE_ITEM_LIMIT_LABEL = "项目数量"
        const val HOME_SAVE_ITEM_LIMIT_DESC = "设置首页「转存/订阅」最多显示的项目数量"
        ...
        const val STORAGE_PATH_MANAGEMENT_LABEL = "存储路径重定向"
        const val STORAGE_PATH_MANAGEMENT_DESC = "选择 SAF 公共目录，重定向下载并保护公共根目录"
        const val STORAGE_DOWNLOAD_REDIRECT_LABEL = "下载重定向"
        const val STORAGE_DOWNLOAD_REDIRECT_DESC = "普通下载、分享、URL/H5、BT/P2P 使用所选公共目录，失效时阻止任务"
        const val STORAGE_REMOVE_OUTER_PATH_LABEL = "移除外层文件路径"
        const val STORAGE_REMOVE_OUTER_PATH_DESC = "将下载文件和文件夹直接放到所选重定向目录根目录，移除云端外层路径"
        const val STORAGE_ROOT_GUARD_LABEL = "公共根目录保护"
        const val STORAGE_ROOT_GUARD_DESC = "阻止宿主在 /storage/emulated/0 创建文件夹"
        const val STORAGE_DIRECTORY_SECTION_TITLE = "下载目录"
        const val STORAGE_OPTIONS_SECTION_TITLE = "重定向选项"
        const val STORAGE_DOWNLOAD_DIRECTORY_LABEL = "公共下载目录"
        const val STORAGE_SELECT_DIRECTORY = "选择目录"
        const val STORAGE_RESELECT_DIRECTORY = "重新选择"
        const val STORAGE_DIRECTORY_NONE = "未选择公共目录"
        const val STORAGE_DIRECTORY_SELECT_HINT = "点击选择支持 SAF 授权的公共目录"
        const val STORAGE_DIRECTORY_PERMISSION_VALID = "目录授权有效 · 可读写"
        const val STORAGE_DIRECTORY_PERMISSION_INVALID = "目录授权无效，请重新选择"
        const val STORAGE_DIRECTORY_SELECTED = "公共下载目录已保存，重启宿主后生效"
        const val STORAGE_SETTINGS_SAVED = "存储路径重定向配置已保存"
        const val STORAGE_DIRECTORY_PICK_FAILED = "无法打开系统目录选择器"
        const val STORAGE_WECHAT_BACKUP_LABEL = "三星微信备份重定向"
        const val STORAGE_WECHAT_BACKUP_DESC = "将 WeChatCloudBackup 备份/恢复目录改到所选目录下"
        const val STORAGE_READER_SDK_LABEL = "阅读器/搜索 SDK 目录重定向"
        const val STORAGE_READER_SDK_DESC = "将阅读器、文库和搜索 SDK 临时目录放入宿主私有目录"
        ...
        const val HIDE_ABOUT_ME_MANAGE_SPACE_TEXT_LABEL = "存储空间"
        const val HIDE_ABOUT_ME_MANAGE_SPACE_TEXT_DESC = "隐藏该槽位下的“管理空间”文案"
        const val HIDE_ABOUT_ME_REWARD_TEXT_LABEL = "任务系统"
        const val HIDE_ABOUT_ME_REWARD_TEXT_DESC = "隐藏该槽位下的“领奖励”文案"
        const val HIDE_ABOUT_ME_ACCOUNT_EXIT_TEXT_LABEL = "设置"
        ...
        const val CUSTOM_SECTION_DISPLAY_SECTION_TITLE = "自定义板块显示"
        ...
        const val REPOSITORY = "仓库"
        const val SOURCE_REPOSITORY_URL = "https://github.com/xiyunmn/PureDuPan"
