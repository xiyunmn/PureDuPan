...
object UiText {
    object Settings {
        ...
        const val SEARCH_PAGE_CUSTOMIZE_DESC = "管理搜索页面 AI 入口、提示词、智能推荐和语音搜索"
        ...
        const val HIDE_SEARCH_PAGE_VOICE_SEARCH_DESC = "隐藏搜索页弹出键盘后显示的语音搜索入口"
        ...
        const val BLOCK_INTL_OFFLINE_PACKAGE_INIT_DESC = "阻止启动期 H5 离线包配置监听和自动下载队列初始化；进入 H5/离线包页面前按需恢复"
        ...
        const val DELAY_INTL_TASK_SCORE_REFRESH_DESC = "启动期跳过任务积分/会员频道的非强制刷新，首页稳定后或进入会员任务入口前自动恢复；强制刷新不拦截"
        ...
        const val DELAY_INTL_NON_CORE_DIFF_SOCKET_DESC = "启用 DexKit 解析后生效\n启动期延后云图、云视频、搜索 diff socket 注册，保留核心文件 diff；首页稳定后或进入对应入口前恢复"
