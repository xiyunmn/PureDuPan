...
internal object SettingsUserState {
    fun popupBoolean(prefs: SharedPreferences, key: String): Boolean =
        MarketingPopup.savedValue(key, prefs::contains) { prefs.getBoolean(it, false) }
    ...
    const val KEY_POPUP_BLOCK = ConfigManager.KEY_POPUP_BLOCK
    const val KEY_BLOCK_POPUP_OPERATION_ANIMATION = ConfigManager.KEY_BLOCK_POPUP_OPERATION_ANIMATION
    const val KEY_BLOCK_POPUP_OPERATION_AFX = ConfigManager.KEY_BLOCK_POPUP_OPERATION_AFX
    const val KEY_BLOCK_POPUP_NEW_USER_OFFER = ConfigManager.KEY_BLOCK_POPUP_NEW_USER_OFFER
    const val KEY_BLOCK_POPUP_NEW_USER_REWARD = ConfigManager.KEY_BLOCK_POPUP_NEW_USER_REWARD
    const val KEY_BLOCK_POPUP_NEW_USER_REWARD_V2 = ConfigManager.KEY_BLOCK_POPUP_NEW_USER_REWARD_V2
    const val KEY_BLOCK_POPUP_COIN_PROMOTION = ConfigManager.KEY_BLOCK_POPUP_COIN_PROMOTION
    const val KEY_BLOCK_POPUP_COUPON_GIFT_V3 = ConfigManager.KEY_BLOCK_POPUP_COUPON_GIFT_V3
    const val KEY_BLOCK_POPUP_COUPON_GIFT_V2 = ConfigManager.KEY_BLOCK_POPUP_COUPON_GIFT_V2
    const val KEY_BLOCK_POPUP_LIFE_COUPON = ConfigManager.KEY_BLOCK_POPUP_LIFE_COUPON
    const val KEY_BLOCK_POPUP_LIFE_PRODUCT = ConfigManager.KEY_BLOCK_POPUP_LIFE_PRODUCT
    const val KEY_BLOCK_POPUP_LIFE_PRODUCT_V3 = ConfigManager.KEY_BLOCK_POPUP_LIFE_PRODUCT_V3
    const val KEY_BLOCK_POPUP_LIFE_V10 = ConfigManager.KEY_BLOCK_POPUP_LIFE_V10
    const val KEY_BLOCK_POPUP_LIFE_V10_REPURCHASE = ConfigManager.KEY_BLOCK_POPUP_LIFE_V10_REPURCHASE
    const val KEY_BLOCK_POPUP_LIFE_COMBO = ConfigManager.KEY_BLOCK_POPUP_LIFE_COMBO
    const val KEY_BLOCK_POPUP_LIFE_LIMITED = ConfigManager.KEY_BLOCK_POPUP_LIFE_LIMITED
    const val KEY_BLOCK_POPUP_LIFE_RETENTION = ConfigManager.KEY_BLOCK_POPUP_LIFE_RETENTION
    const val KEY_BLOCK_POPUP_LIFE_PRICE_UPGRADE = ConfigManager.KEY_BLOCK_POPUP_LIFE_PRICE_UPGRADE
    const val KEY_BLOCK_POPUP_OVERDUE_UNION = ConfigManager.KEY_BLOCK_POPUP_OVERDUE_UNION
    const val KEY_BLOCK_POPUP_OVERDUE_COUPON = ConfigManager.KEY_BLOCK_POPUP_OVERDUE_COUPON
    const val KEY_BLOCK_POPUP_OVERDUE_PRODUCT = ConfigManager.KEY_BLOCK_POPUP_OVERDUE_PRODUCT
    const val KEY_BLOCK_POPUP_MY_PAGE_OFFER = ConfigManager.KEY_BLOCK_POPUP_MY_PAGE_OFFER
    const val KEY_BLOCK_POPUP_INCENTIVE_ENTRANCE = ConfigManager.KEY_BLOCK_POPUP_INCENTIVE_ENTRANCE
    const val KEY_BLOCK_POPUP_INCENTIVE_GUIDE = ConfigManager.KEY_BLOCK_POPUP_INCENTIVE_GUIDE
    const val KEY_BLOCK_POPUP_INCENTIVE_NEXT = ConfigManager.KEY_BLOCK_POPUP_INCENTIVE_NEXT
    const val KEY_BLOCK_POPUP_FREE_MODE = ConfigManager.KEY_BLOCK_POPUP_FREE_MODE
    const val KEY_BLOCK_POPUP_FREE_MODE_NEW = ConfigManager.KEY_BLOCK_POPUP_FREE_MODE_NEW
    const val KEY_BLOCK_POPUP_FREE_MODE_FLOAT = ConfigManager.KEY_BLOCK_POPUP_FREE_MODE_FLOAT
    const val KEY_BLOCK_POPUP_MIGHTY_MARKETING = ConfigManager.KEY_BLOCK_POPUP_MIGHTY_MARKETING
    const val KEY_BLOCK_POPUP_MODERATE_MARKETING = ConfigManager.KEY_BLOCK_POPUP_MODERATE_MARKETING
    const val KEY_BLOCK_POPUP_SEARCH_MEMBERSHIP = ConfigManager.KEY_BLOCK_POPUP_SEARCH_MEMBERSHIP
    const val KEY_BLOCK_POPUP_TRANSFER_COUPON = ConfigManager.KEY_BLOCK_POPUP_TRANSFER_COUPON
    const val KEY_BLOCK_POPUP_TRANSFER_LIMIT = ConfigManager.KEY_BLOCK_POPUP_TRANSFER_LIMIT
    const val KEY_BLOCK_POPUP_TRANSFER_SPACE = ConfigManager.KEY_BLOCK_POPUP_TRANSFER_SPACE
    ...
    const val KEY_HIDE_HOME_RECOMMEND_SECTION = ConfigManager.KEY_HIDE_HOME_RECOMMEND_SECTION
    ...
    const val KEY_STORAGE_REDIRECT_ENABLED = ConfigManager.KEY_STORAGE_REDIRECT_ENABLED
    const val KEY_STORAGE_DOWNLOAD_REDIRECT_ENABLED = ConfigManager.KEY_STORAGE_DOWNLOAD_REDIRECT_ENABLED
    const val KEY_STORAGE_DOWNLOAD_TREE_URI = ConfigManager.KEY_STORAGE_DOWNLOAD_TREE_URI
    const val KEY_STORAGE_REMOVE_OUTER_PATH = ConfigManager.KEY_STORAGE_REMOVE_OUTER_PATH
    const val KEY_STORAGE_ROOT_GUARD_ENABLED = ConfigManager.KEY_STORAGE_ROOT_GUARD_ENABLED
    const val KEY_STORAGE_WECHAT_BACKUP_REDIRECT_ENABLED = ConfigManager.KEY_STORAGE_WECHAT_BACKUP_REDIRECT_ENABLED
    const val KEY_STORAGE_READER_SDK_REDIRECT_ENABLED = ConfigManager.KEY_STORAGE_READER_SDK_REDIRECT_ENABLED
    const val KEY_BLOCK_TRANSFER_SVIP_CARD = ConfigManager.KEY_BLOCK_TRANSFER_SVIP_CARD
    ...
    const val KEY_MEMBER_CARD_DEFAULT_SIZE_SIGNATURE =
