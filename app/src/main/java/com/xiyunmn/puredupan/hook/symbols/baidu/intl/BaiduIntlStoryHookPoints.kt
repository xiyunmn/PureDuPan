...
internal object BaiduIntlStoryHookPoints {
    ...
    const val STORY_VIDEO_PRELOADER_OWNER_PREFIX =
        "Lcom/mars/united/storyvideo/preload/StoryVideoPreloaderContextKt;->"
    const val STORY_VIDEO_PRELOADER_SIGNATURE =
    ...
    const val STORY_UI_SERVICE_INIT_SIGNATURE =
