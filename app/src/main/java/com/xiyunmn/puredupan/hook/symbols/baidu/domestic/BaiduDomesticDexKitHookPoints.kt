...
internal object BaiduDomesticDexKitHookPoints {
    ...
    const val ADVERTISE_SDK_DOWNLOAD_VIDEO_FRONT_AD_13_27_METHOD = "g"
    const val ADVERTISE_SDK_METADATA_CLASS = "Lcom/baidu/netdisk/advertise/AdvertiseSDK;"
    const val ADVERTISE_SDK_METADATA_DOWNLOAD_VIDEO_FRONT_AD = "downloadVideoFrontAd"
    const val ADVERTISE_SDK_METADATA_PRELOAD_VIDEO_FRONT_ADS = "preloadVideoFrontAds"
    const val MARS_ADVERTISE_SDK = "com.mars.advertise.MarsAdvertiseSDK"
    const val MARS_ADVERTISE_SDK_DOWNLOAD_VIDEO_FRONT_AD_13_27_METHOD = "k"
    const val MARS_ADVERTISE_SDK_METADATA_CLASS = "Lcom/mars/advertise/MarsAdvertiseSDK;"
    const val MARS_ADVERTISE_SDK_METADATA_DOWNLOAD_VIDEO_FRONT_AD = "downloadVideoFrontAd"
    ...
    const val CLIENT_COMPUTE_MANAGER_13_27_CLASS = "newhome.m8b"
    const val CLIENT_COMPUTE_MANAGER_13_27_JADX_CLASS = "kotlin.m8b"
    const val CLIENT_COMPUTE_MANAGER_INIT_13_27_METHOD = "___"
    ...
    const val THUMBNAIL_ADD_JOB_13_27_METHOD = "_"
