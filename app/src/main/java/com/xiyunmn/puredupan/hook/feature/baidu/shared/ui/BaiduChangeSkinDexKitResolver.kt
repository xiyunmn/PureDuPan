...
internal object BaiduChangeSkinDexKitResolver {
    const val CACHE_ID = "shared_change_skin_v2"
    ...
    fun resolve(cl: ClassLoader): Method? {
        ...
        if (XposedCompat.findClassOrNull(BaiduThemeHookPoints.SKIN_LOADER_LISTENER, cl) == null) {
    ...
    private fun resolveRef(
        ...
        val listenerClass = XposedCompat.findClassOrNull(BaiduThemeHookPoints.SKIN_LOADER_LISTENER, cl)
            ?: return null
    ...
    private fun DexMethodCandidate.isChangeSkinShape(): Boolean =
        !isConstructor &&
            returnTypeName == "void" &&
            paramTypeNames == listOf("java.lang.String", BaiduThemeHookPoints.SKIN_LOADER_LISTENER) &&
                ...
                FindMethod.create()
                    .matcher(
                        MethodMatcher.create()
                            ...
                            .paramTypes(
                                "java.lang.String",
                                BaiduThemeHookPoints.SKIN_LOADER_LISTENER,
                            ),
                    ),
            ).map { methodData ->
                DexMethodCandidate(
    ...
    private const val TAG = "BaiduChangeSkinDexKitResolver"
}
