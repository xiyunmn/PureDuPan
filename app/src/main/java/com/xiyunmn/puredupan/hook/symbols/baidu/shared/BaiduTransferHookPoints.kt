...
internal object BaiduTransferHookPoints {
    ...
    const val YUN_GAME_GUIDE_VIEW_MODEL =
        "com.baidu.netdisk.business.viewmodel.YunGameGuideViewModel"
    const val I_TRANSFER_YOUA =
        "com.baidu.netdisk.ui.transfer.ITransferYoua"
    const val YOUA_GUIDE =
        "com.baidu.netdisk.ui.youaguide.YouaGuide"
    const val ALBUM_GUIDE_RESULT_SUCCESS =
